...
public class OutcomePerMonthListAdapter
        extends ListAdapter<OutcomeRow, OutcomePerMonthListAdapter.VH> {

    public OutcomePerMonthListAdapter() { super(DIFF); }
    ...
    public void onBindViewHolder(@NonNull VH h, int pos) {
        ...
        if (row.isPurchase()) {                       // show extra fields only for Purchases
        ...
        h.tvCost.setText(String.format("Cost: %.2f €", euros));
    }
